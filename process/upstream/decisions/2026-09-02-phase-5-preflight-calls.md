...
date: '2026-09-02'
question: |
  Three calls needed before Stage 1 code could be written: (1)
...
decision: |
  (1) Retirement routes through the identical per-level gate as
...
alternatives: |
  ["(1) Let Stage 6's report auto-retire a practice past some
