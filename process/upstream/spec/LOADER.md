...
| | |
|---|---|
| Practices in the catalogue | 57 |
| Resident, loaded every session | 6 of 57 practices |
...
| Carrying a `## Detail` | 19 |
| Carrying a `## Story` | 24 |
| Enforced by a check | 26 of 57 practices carry a `checked_by` |
<!--/gen:catalogue-->
