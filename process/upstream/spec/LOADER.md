...
| | |
|---|---|
| Practices in the catalogue | 54 |
| Resident, loaded every session | 6 of 54 practices |
...
| Carrying a `## Detail` | 16 |
| Carrying a `## Story` | 21 |
| Enforced by a check | 24 of 54 practices carry a `checked_by` |
<!--/gen:catalogue-->
