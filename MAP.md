...
of prompts, workflows, and observations about working with AI. Everything
else here is the practice layer that keeps the repo itself well-run:
BestPractice (vendored, unmodified) plus Morgan's personal pack on top.
...
| `process/personal/` | Morgan's personal pack, vendored from RepoPersonalPreferences — see [process/personal/README.md](process/personal/README.md) and [process/manifest_personal.json](process/manifest_personal.json). |
