...
Recorded in [CHANGES_TO_TELL_ALEX.md](../process/upstream/CHANGES_TO_TELL_ALEX.md).
...
(schema of [INSTALL.md](../process/upstream/INSTALL.md) §5, plus `upstream.scrub_blocklist` — a
