...
## Install
[templates/pull_request_template.md.template](../process/upstream/templates/pull_request_template.md.template)
...
[templates/AGENTS.md.template](../process/upstream/templates/AGENTS.md.template) so every
