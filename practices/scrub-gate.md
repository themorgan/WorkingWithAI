...
vocabulary), and [tools/practice_audit.py](../process/upstream/tools/practice_audit.py) scans
...
## Install
Blocklist format and gate wiring in [INSTALL.md](../process/upstream/INSTALL.md).
