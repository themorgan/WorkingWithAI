...
## Install
[templates/bootstrap.sh](../process/upstream/templates/bootstrap.sh) →
`tools/bootstrap.sh` (harness-neutral; all real setup lives here), wired in
per-harness via [templates/harness/](../process/upstream/templates/harness/README.md): a hook
...
[templates/harness/claude-code/hooks/stop-git-check.sh](../process/upstream/templates/harness/claude-code/hooks/stop-git-check.sh)),
...
[`templates/harness/claude-code/hooks/individual-source-bootstrap.sh.template`](../process/upstream/templates/harness/claude-code/hooks/individual-source-bootstrap.sh.template) →
...
[spec/BOOTSTRAP_NEW_SOURCES.md](../process/upstream/spec/BOOTSTRAP_NEW_SOURCES.md)). It
