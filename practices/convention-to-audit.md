...
2026-08). A required CI check ([GITHUB_ACTIONS.md](../process/upstream/GITHUB_ACTIONS.md)) is
...
[tools/practice_audit.py](../process/upstream/tools/practice_audit.py) are audits of this kind
