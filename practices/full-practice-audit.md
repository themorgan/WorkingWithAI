...
[tools/full_practice_audit.py](../process/upstream/tools/full_practice_audit.py): it enumerates
...
[spec/ATTENTION_CEILING.md](../process/upstream/spec/ATTENTION_CEILING.md) pre-registered and
...
and 2026-09-05** ([spec/ATTENTION_CEILING.md](../process/upstream/spec/ATTENTION_CEILING.md),
...
[spec/UNBUILT_PLAN_ITEMS.md](../process/upstream/spec/UNBUILT_PLAN_ITEMS.md) still names as
open.
...
## Install
[tools/full_practice_audit.py](../process/upstream/tools/full_practice_audit.py) is the
