...
in [INSTALL.md](../process/upstream/INSTALL.md), which also instantiates a baseline
`.gitignore` from [templates/gitignore.template](../process/upstream/templates/gitignore.template)
