...
[GLOSSARY.md](../process/upstream/templates/GLOSSARY.md.template) — a plain pair like *light
...
[tools/practice_audit.py](../process/upstream/tools/practice_audit.py) is already the full one
