<!-- Last updated: 2026-09-01 16:46:35 (Buenos Aires) by Morgan F, to version 40 -->
...
- [x] **Populate [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) with real content.** Done
  2026-08-26 → [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) now holds the first real brainstorm
  batch, plus [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) promoted out as its own
  document. The three original placeholder sections (prompts, workflows,
  incidents) are still empty and open for the next batch.
- [x] **Restructure [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md):
  ...
  (this file, [AGENTS.md](AGENTS.md), [RANDOM_NOTES.md](docs/RANDOM_NOTES.md),
  ...
  just cut; logged as a 2026-08-29 entry in [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) to
  ...
  [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md), and
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) was updated to match;
...
- [x] **Shorten every rule paragraph in [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)
...
- [x] **Fill in the two open brackets in [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md).**
...
- [ ] **Look for contradictions across [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) entries**, per
  ...
  Now also item 7 of [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) — this line
...
- [ ] **Design real infrastructure for active/proactive resurfacing** —
  [`active-resurfacing`](docs/AI_GOVERNANCE_TO_COCREATE.md#active-resurfacing)'s
  "you decided X six weeks ago, unprompted" test,
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md)'s "Not yet
...
- [ ] **Design automatic workflow-candidate detection** — mining
  ...
  solely on [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) item 4's
  human-triggered reflex. **analysis.**
- [ ] **Work out situational, inferred cost-awareness** —
  [`cost-awareness-situational`](docs/AI_GOVERNANCE_TO_COCREATE.md#cost-awareness-situational)
...
- [ ] **Formalize the coldstart test as a periodic check** — can a fresh
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md); worth deciding whether it
...
- [x] **Close the gap [`hire-for-drive`](docs/COMPANY_BUILDING_RULES.md#hire-for-drive)
  left out of the "what humans are good at" consolidation, and check the
  rest of [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) for
  ...
  [HUMANS_AT_OUR_BEST.md](docs/HUMANS_AT_OUR_BEST.md) and missed a fourth:
  [`hire-for-drive`](docs/COMPANY_BUILDING_RULES.md#hire-for-drive) itself
  ...
  [`no-ai-voice`](docs/COMPANY_BUILDING_RULES.md#no-ai-voice) argues for the
  ...
  and [`write-like-a-human`](docs/RULES_NOW_TESTING.md#write-like-a-human).
...
- [x] **Give [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md)
  ...
  done, doc. Morgan noticed [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) item 1
  ...
  treatment as [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) —
  ...
  slug, matching [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)'s
  ...
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) items 1 and 5,
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md)'s "Not yet ready" list,
  and two open items in this file. Also checked
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) itself for the
  ...
  **Judgment calls made:** (1) picked one slug per item from its own
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) already has its own
  ...
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)'s own four
...
- [x] **Cite every durable numbered list by permanent slug, not position —
  ...
  home in [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) required a corollary
  ...
  every rule in [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)
  (15), every item in [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) (7) and
  [REASONS_WHY.md](docs/REASONS_WHY.md) (9), and every rule in
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) (7, already headed — still
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md),
  [HUMANS_AT_OUR_BEST.md](docs/HUMANS_AT_OUR_BEST.md), and [RANDOM_NOTES.md](docs/RANDOM_NOTES.md)
  ...
  did not add anchors to [RANDOM_NOTES.md](docs/RANDOM_NOTES.md)'s own numbered brainstorm
  ...
  N" mentions inside [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) itself that cite
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) to the new slug
...
- [x] **Pull the scattered "what humans are good at" lists into one
  ...
  leaving the existing text unchanged. Found three spots: [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md)
  item 4 (planning, taste, judgment), [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md)
  item 7 (judgment, relationships, instinct — reading a room, sensing the
  unspoken, pushing harder), and [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)
  ...
  [HUMANS_AT_OUR_BEST.md](docs/HUMANS_AT_OUR_BEST.md), gathering all of it
  ...
  quick index. Judgment calls made: (1) treated [REASONS_WHY.md](docs/REASONS_WHY.md)
  ...
  right after [REASONS_WHY.md](docs/REASONS_WHY.md) in each index, since it's
...
- [x] **Stop citing a specific point inside [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) (the
  ...
  flagged [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md)'s
  ...
  document. Re-pointed it at [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) item 5
  and [REASONS_WHY.md](docs/REASONS_WHY.md) item 2, which already state the same
...
- [x] **Flip the pre-rename VoiceGuidelinesToSoundHuman URLs to
  ...
  links in [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md), [MAP.md](MAP.md),
...
- [x] **Add a theory-level intro pair: what this is and why it's worth
  ...
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) (seven named ideas, current
  ...
  continuous not a one-time handoff) and [REASONS_WHY.md](docs/REASONS_WHY.md) (seven subtler benefits: cheap early
  ...
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md),
  [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md), and
  [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) rather than restating them. Wired into
  ...
  **Revised same day** — Morgan flagged item 7 (the pipeline's earned-trust
  ...
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)'s own bolded
  ...
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md): item 4 ("judgment is scarce,
  ...
  otherwise unchanged. In [REASONS_WHY.md](docs/REASONS_WHY.md): item 2
  ...
  [REASONS_WHY.md](docs/REASONS_WHY.md)'s own length alone — Morgan asked for
  the halving pass only on [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md).
  **Revised a third time 2026-08-28** — three changes to
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) and one to
  [REASONS_WHY.md](docs/REASONS_WHY.md), all Morgan's. Philosophy gained a new
  ...
  [REASONS_WHY.md](docs/REASONS_WHY.md), item 3 ("how someone's doing stops
  ...
  new [REASONS_WHY.md](docs/REASONS_WHY.md) item with this repo's own
  ...
  **Revised a fourth time 2026-08-28** — two more edits to
  [REASONS_WHY.md](docs/REASONS_WHY.md), both Morgan's. Item 4's opening line
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) item 7) attached to the
  folded-in sentences rather than dropping them.
  **Revised a fifth time 2026-08-28** — one change to
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md), Morgan's. Item 4 ("quality comes
  ...
  rule 4 and [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md)
  ...
  **Revised a sixth time 2026-08-28** — one typo fix to
  [REASONS_WHY.md](docs/REASONS_WHY.md), Morgan's. Item 4's title had been left
  ...
  **Revised a seventh time 2026-08-28** — a new item added to
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md), not a rewrite of an existing
  ...
  put it in [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) rather than a new
  ...
  above — the eight names in [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) are
  ...
  **Revised a tenth time 2026-08-28** — four more changes to
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md), Morgan's, same day. Step 3 of
  ...
  repointed [REASONS_WHY.md](docs/REASONS_WHY.md)'s citation of the old item
  ...
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) rule (as
  against a BestPractice practice or a
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) rule, both cited
  ...
  [REASONS_WHY.md](docs/REASONS_WHY.md), fixed above; (3) linked every rule
  citation to the bare file rather than a specific anchor —
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)'s fifteen
  ...
  **Revised an eleventh time 2026-08-28** — one more change to
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md), Morgan's, same day. Step 4 of
  ...
  **Revised a twelfth time 2026-08-28** — three more changes, Morgan's,
  ...
  ([COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md)'s bold
  paragraphs). Brought into compliance immediately:
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) item 6's `(practices 5, 20)`,
  and every practice citation already inside
  [AGENTS.md](AGENTS.md) itself (nine of them, plus its one
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) item citation). Second, a
  new sixth [REASONS_WHY.md](docs/REASONS_WHY.md) reason: AI is superhuman at
  ...
  Third, all five existing [REASONS_WHY.md](docs/REASONS_WHY.md) reasons
  (plus the new sixth) shortened to roughly half their prior length,
  matching [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md)'s own brevity — kept
  ...
  ([RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md)'s own self-references,
  [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md)'s and
  [RANDOM_NOTES.md](docs/RANDOM_NOTES.md)'s `rule N` mentions) into this same change — logged
  ...
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) renumbering work as the concrete
...
- [x] **Rename OPERATING_RULES.md, FIFTEEN_RULES.md, and COCREATION_DESIGN.md
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md),
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md), and
  [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md) respectively,
  ...
  [README.md](README.md), [RANDOM_NOTES.md](docs/RANDOM_NOTES.md), and this file updated to
  ...
  **the rules now testing** in [GLOSSARY.md](GLOSSARY.md) (kept in step with
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) for the middle document —
  ...
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) and
  [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md) verbatim for
  the other two; (3) while
  rewriting [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md)'s opening
...
- [x] **Vendor the voice guidelines in, with their own weekly sync and
  ...
  had flagged item 5 of [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) ("a
  ...
  documents — and [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) item 5 now
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) item 5 at *Trial* rather than
  ...
  only for reference.
- [x] **Give this repo an explicit third stage — [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md)
  ...
  [RANDOM_NOTES.md](docs/RANDOM_NOTES.md) / the promoted essays, (2) try it for real in a new
  document, (3) only then port proven rules into RepoPersonalPreferences
  for rollout everywhere. Landed as
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) (new document, seeded with
  items 1-2 already promoted from a prior session, items 3-7 as trial
  rules pulled straight from [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md)
  and [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md), and a "not yet ready" section
  ...
  **promote**/**promotion**), [AGENTS.md](AGENTS.md)'s quick
  ...
  [RANDOM_NOTES.md](docs/RANDOM_NOTES.md). Judgment calls made: (1) named it
  `OPERATING_RULES.md` (since renamed to
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md), see below) rather than
...
- [x] **Force deeper AI engagement, or just permit it?** Decided
  ...
  resurfacing of rules) is still open — see [RANDOM_NOTES.md](docs/RANDOM_NOTES.md)
...
- [x] **Halve [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md)'s and
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md)'s numbered items, and cut
  ...
  point. Rewrote all seven [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) items
  and all seven [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) rules,
  ...
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) (from the prior session's
  ...
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) intro has the same
  ...
  history from [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) — that
  provenance still lives in this file's own history, and
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md) is the current-state
...
- [x] **Write [THE_REVOLUTIONARY_FORMULA.md](docs/THE_REVOLUTIONARY_FORMULA.md)
  and add a new [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) point for
  group collaboration.** Decided 2026-09-01 → done, doc. Promoted
  [RANDOM_NOTES.md](docs/RANDOM_NOTES.md)'s three-part uniqueness thesis into a
  one-page pitch, linked from
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md),
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md), and
  [REASONS_WHY.md](docs/REASONS_WHY.md). Morgan's first-round correction: the
  formula's first bullet isn't
  [`co-create-dont-delegate`](docs/COMPANY_BUILDING_RULES.md#co-create-dont-delegate)
  ...
  [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md) point,
  [`groups-not-individuals`](docs/OUR_PHILOSOPHY.md#groups-not-individuals),
...
- [x] **Move the main content documents into `docs/`, add uniform
  ...
  [HUMANS_AT_OUR_BEST.md](docs/HUMANS_AT_OUR_BEST.md)'s upkeep rule into a
  doc-recipe.** Decided 2026-09-01 → done, doc. Five separate asks in one
  round:

  (1) [THE_REVOLUTIONARY_FORMULA.md](docs/THE_REVOLUTIONARY_FORMULA.md)'s
  second bullet is now "Protocols Generated Automatically (Then Reviewed
  By Humans)."

  (2) [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md) rule 14
  ...
  (3) [HUMANS_AT_OUR_BEST.md](docs/HUMANS_AT_OUR_BEST.md)'s "Keeping this
  ...
  into [docs/doc-recipes/HUMANS_AT_OUR_BEST.recipe.md](docs/doc-recipes/HUMANS_AT_OUR_BEST.recipe.md) — a standing rule
  about the file, not part of its content, which is exactly what
  [`doc-recipe`](process/personal/README.md#doc-recipe) is for.

  (4) [OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md)'s `groups-not-individuals`
  ...
  ([OUR_PHILOSOPHY.md](docs/OUR_PHILOSOPHY.md),
  [REASONS_WHY.md](docs/REASONS_WHY.md),
  [HUMANS_AT_OUR_BEST.md](docs/HUMANS_AT_OUR_BEST.md),
  [RANDOM_NOTES.md](docs/RANDOM_NOTES.md),
  [COMPANY_BUILDING_RULES.md](docs/COMPANY_BUILDING_RULES.md),
  [AI_GOVERNANCE_TO_COCREATE.md](docs/AI_GOVERNANCE_TO_COCREATE.md),
  [RULES_NOW_TESTING.md](docs/RULES_NOW_TESTING.md),
  [THE_REVOLUTIONARY_FORMULA.md](docs/THE_REVOLUTIONARY_FORMULA.md)) now
  ...
  [doc-recipes/GLOSSARY.recipe.md](doc-recipes/GLOSSARY.recipe.md) so this
  doesn't get re-litigated as a tidiness call next time root looks
  cluttered; (2) gave
  [THE_REVOLUTIONARY_FORMULA.md](docs/THE_REVOLUTIONARY_FORMULA.md)'s own
  ...
  [THE_REVOLUTIONARY_FORMULA.md](docs/THE_REVOLUTIONARY_FORMULA.md) to
